...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('kriteria.create') }}" class="btn btn-sm btn-primary shadow-sm">
            <i class="fa fa-plus fa-sm text-white-50"></i> Tambah Kriteria
        </a>
    </div>
            ...
            <div class="table-responsive">
                <table class="table-bordered text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $items->id }}</td>
                            <td>{{ $items->jenis_kriteria }}</td>
                            <td>
                                <a href="{{ route('kriteria.edit', $items->id) }}" class="btn btn-info">
                                    <i class="fa fa-pencil-alt"></i>
                                </a>
                                <form action="{{ route('kriteria.destroy', $items->id) }}" method="post"
                                    class="d-inline">
                                    @csrf
                                    @method('delete')
