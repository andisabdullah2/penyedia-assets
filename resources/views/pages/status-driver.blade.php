...
<section class="py-5">
    ...
    <div class="row">
        <div class="card-body">
        <center><h2>Status Pemesanan Mobil Penumpang</h2> </center>
            <br>
                ...
                <table class="table-bordered text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('update-status-driver.update', $item->orders_penumpang_id) }}" method="post"
                                    class="d-inline">
                                    ...
                                    @csrf
                                    @method('PUT') 
                                    <button class="btn btn-danger" {{ $item->status == 2 || $item->status == 3 ? 'disabled' : '' }}>
                                        <i class="fa fa-trash"></i> Konfirmasi
                                    </button>
                                </form>
                ...
                <table class="table-bordered text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('update-status-barangdriver.update', $items->orders_barang_id) }}" method="post"
                                    class="d-inline">
                                    ...
                                    @csrf
                                    @method('PUT') 
                                    <button class="btn btn-danger"{{ $items->status == 2 || $items->status == 3 ? 'disabled' : '' }}>
                                        <i class="fa fa-trash"></i> Konfirmasi
                                    </button>
                                </form>
                            </td>
