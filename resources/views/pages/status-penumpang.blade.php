                ...
                <table class="table-bordered text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('update-status-penumpang.update', $item->orders_penumpang_id) }}" method="post"
                                    class="d-inline">
                                    ...
                                    @csrf
                                    @method('PUT') 
                                    <button class="btn btn-danger"{{ $item->status == 1 || $item->status == 3 ? 'disabled' : '' }}>
                ...
                <table class="table-bordered text-center" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('update-status-barang.update', $items->orders_barang_id) }}" method="post"
                                    class="d-inline">
                                    ...
                                    @csrf
                                    @method('PUT') 
                                    <button class="btn btn-danger"{{ $items->status == 1 || $items->status == 3 ? 'disabled' : '' }}>
                                        <i class="fa fa-trash"></i> selesai
                                    </button>
                                </form>
                            </td>
